...
Odoo CLI is a command tool for Odoo management, configuration and upgrade. Connect Odoo server with SSH and run the command `odoo -h` to list all usage command of Odoo below:
...
More detail about Odoo CLI, refer to Odoo official docs: [Command-line interface: odoo-bin](https://www.odoo.com/documentation/13.0/reference/cmdline.html)
